...
const VerticalAxis = ({ scale }) => {
    ...
    return <g className="y-axis" transform={`translate(20,0)`}>
...
const Histogram = ({ data }) => {
    ...
    return <div><svg viewBox="0 0 100 100">
        {/*<VerticalAxis scale={yScale} />*/}
        {/*<HorizontalAxis scale={xScale} />*/}
        {bins.slice(0, 2).map((bin, i) => <rect className="bin" key={i} x={xScale(bin.x0)} y={yScale(bin.length)}
